...
class BeaconWidget2 extends StatefulWidget {
  @override
  _BeaconWidget2State createState() => _BeaconWidget2State();
}

class _BeaconWidget2State extends State<BeaconWidget2>
  ...
  initScanBeacon() async {
    ...
    final regions = <Region>[
      Region(
        identifier: 'alieyah',
        proximityUUID: 'b9407f30-f5f8-466e-aff9-25556b57fe6b',
      ),
    ];
